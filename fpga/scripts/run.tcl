...
if {$::env(BOARD) eq "nexys_video"} {
      read_ip xilinx/nexys_video_axi_quad_spi_flash/ip/nexys_video_axi_quad_spi_flash.xci
}
...
if {$::env(BOARD) eq "genesys2"} {
    ...
    set registers "../src/common_cells/include/common_cells/registers.svh"
      ...
      read_verilog -sv {src/nexys_video.svh ../src/common_cells/include/common_cells/registers.svh}
